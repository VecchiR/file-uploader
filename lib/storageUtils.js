...
async function getMoveData(req, res) {
    ...
    // id for the folder that should be shown in the dialog
    const TEMPfOLDERiD = req.query.parentFolderId ? req.query.parentFolderId : req.params.folderId;
    const isRootFolder = TEMPfOLDERiD ? false : true;
